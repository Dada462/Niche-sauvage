...
if __name__ == '__main__':
    ...
    mtx = np.load(pack_path+"/src/calibration_camera/matrices/camera_matrix.npy")          ##indiquer les valeurs de la calibration de la camera
    dist = np.load(pack_path+"/src/calibration_camera/matrices/distortion_coeffs.npy")
    rvecs = [[[0,0,0]]]
    tvecs = [[[0,0,0]]]
    ids  = -1
    mem_id = 10
